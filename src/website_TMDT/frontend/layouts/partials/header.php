			...
			<div class="row">
				<div class="col d-flex flex-row">
					<div class="top_bar_contact_item">
						<div class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918577/phone.png" alt=""></div><span style="color: black;">0963493525</span>
					</div>
					<div class="top_bar_contact_item">
						<div class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918597/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">CSTORE@gmail.com</a>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-2 col-sm-3 col-3 order-1">
					<div class="logo_container">
						<div class="logo"><a href="#">C STORE</a></div>
					</div>
				</div>
						...
						<div class="header_search_content">
							<div class="header_search_form_container">
								<form action="/website_tmdt/search.php?quanly=timkiem" class="header_search_form clearfix" method="GET">
									<input type="search" required="required" class="header_search_input" placeholder="Tìm kiếm sản phẩm..." name="tukhoa">
									<button type="submit" class="header_search_button trans_300" value="Tìm kiếm" name="timkiem" ><i class="fa fa-search" style="color:white; " aria-hidden="true"></i></button>
								</form>
							</div>
						</div>
					</div>
					...
					<div class="main_nav_content d-flex flex-row">
						...
						<div class="main_nav_menu">
							<ul class="standard_dropdown main_nav_dropdown">
								...
								<li class="hassubs">
									<a id="name_a" href="">Loại sản phẩm</i></a>
									<ul>
								...
								<li><a id="name_a" href="contact.html">Liên hệ<i class="fas fa-chevron-down"></i></a></li>
							</ul>
						</div>
