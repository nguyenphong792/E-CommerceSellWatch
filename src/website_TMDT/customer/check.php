    ...
    <div class="row mb-3">
      ...
      <div class="col change">
        <div class="total-cost">
          ...
          <span>Tổng Thanh Toán: <b><?= number_format($tongthanhtien, 0, ",", ".") . 'đ' ?></b></span>
          <p>Số Sản Phẩm (<?php 
        ...
        <div class="footer">
          <span class="black">Nhấn "Đặt hàng" đồng nghĩa với việc bạn đồng ý tuân theo <a href="#">Điều khoản
              ConCaCShop</a></span>
          <a href="/website_tmdt/customer/purchared.php?giohang_array=<?= $giohang_array ?>">Mua tại đây</a>
        </div>
