      ...
      <div class="row gx-5">
        <div class="col back">
          ...
          <div class="info">
            ...
            <textarea name="noigiaohang" id="noigiaohang" cols="10" rows="1" placeholder="Ghi chú về đơn hàng, ví dụ thời gian hay chỉ dẫn địa điểm giao hàng chi tiết."></textarea>
          </div>
          ...
          <div class="col ml-3 back-line">
                ...
                <div class="card-group">
                  <div class="" id="headingTwo">
                    <h5 class="mb-0">
                      ...
                      <label class="css-card" for="" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Thanh toán trực tiếp tại cửa hàng</label>
                    </h5>
                  </div>
                ...
                <div class="card-group">
                  <div class="" id="headingThree">
                    <h5 class="mb-0">
                      ...
                      <label class="css-card" for="" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Thanh toán trực tuyến & Trả góp trực
                        tuyến</label>
                    </h5>
                  </div>
            ...
            <div class="col">
              <div class="btn btnStyle">
                <input name="btn_insert_ctdh" type="submit" value="Đặt Hàng" class="btn btn-primamry" style="color:white; width: 100%;">
              </div>
