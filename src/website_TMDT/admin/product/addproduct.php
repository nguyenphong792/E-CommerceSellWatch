    ...
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="object1" name="object1" placeholder="Đối tượng sử dụng" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Đường kính mặt:</label>
                <div class="col-md-4">
                    <input id="object2" name="object2" placeholder="Đường kính mặt" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chất liệu mặt kính:</label>
                <div class="col-md-4">
                    <input id="object3" name="object3" placeholder="Chất liệu mặt kính" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chất liệu dây:</label>
                <div class="col-md-4">
                    <input id="object4" name="object4" placeholder="Chất liệu dây" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Bộ máy:</label>
                <div class="col-md-4">
                    <input id="object5" name="object5" placeholder="Bộ máy" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chống nước:</label>
                <div class="col-md-4">
                    <input id="object6" name="object6" placeholder="Chống nước" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Thương hiệu:</label>
                <div class="col-md-4">
                    <input id="object7" name="object7" placeholder="Thương hiệu" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Hãng:</label>
                <div class="col-md-4">
                    <input id="object8" name="object8" placeholder="Hãng" class="form-control input-md" type="text">
                </div>
            </div>
