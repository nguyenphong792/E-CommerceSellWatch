...
<body class="d-flex flex-column h-100">
    ...
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data" autocomplete="off">
        <fieldset>
            ...
            <h4 class="text-center">Thông tin cấu hình chi tiết</h4>
            <div class="form-group">
                <label class="col-md-4 control-label">Đối tượng sử dụng:</label>
                <div class="col-md-4">
                    <input id="object1" name="object1" value="<?= $sanphamRow['object1']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Đường kính mặt:</label>
                <div class="col-md-4">
                    <input id="object2" name="object2" value="<?= $sanphamRow['object2']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chất liệu mặt kính:</label>
                <div class="col-md-4">
                    <input id="object3" name="object3" value="<?= $sanphamRow['object3']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chất liệu dây:</label>
                <div class="col-md-4">
                    <input id="object4" name="object4" value="<?= $sanphamRow['object4']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Bộ máy:</label>
                <div class="col-md-4">
                    <input id="object5" name="object5" value="<?= $sanphamRow['object5']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Chống nước:</label>
                <div class="col-md-4">
                    <input id="object6" name="object6" value="<?= $sanphamRow['object6']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Thương hiệu:</label>
                <div class="col-md-4">
                    <input id="object7" name="object7" value="<?= $sanphamRow['object4']?>" class="form-control input-md" type="text">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Hãng</label>
                <div class="col-md-4">
                    <input id="object8" name="object8" value="<?= $sanphamRow['object8']?>" class="form-control input-md" type="text">
                </div>
            </div>
