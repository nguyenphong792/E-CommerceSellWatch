...
<body>
  ...
  <div class="main-content">
    ...
    <div class="d-flex justify-content-end mr-2">
      <a href="/website_tmdt/admin/order/print.php?maddh=<?= $maddh ?>" class="btn btn-danger">In</a>
    </div>
      ...
      <tbody>
        <?php foreach ($data as $donhang) : ?>
          <tr>
            ...
            <td><a href=""><button class="btn btn-outline-danger">
                  Sửa
                </button></a>
              <a href=""><button class="btn btn-outline-danger ml-2">
                  Xóa
                </button></a>
            </td>
          </tr>
