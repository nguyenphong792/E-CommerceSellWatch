            ...
            <div class="title-info mt-3">
              ...
              <div class="method mt-3">
                <?php if (!isset($_SESSION['makh'])) { ?>
                  <div class="add-cart">
                    <a class="btn" href="/website_tmdt/customer/login-register/dangnhap_dangky.php?masp=<?= $masp ?>&math=<?= $math ?>" name="btnThem">Thêm Vào Giỏ Hàng</a>
                  </div>
                  <div class="buy">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body container">
                      <div class="container">
                        <div class="group">
                          <h4 class="text-3"><span class="badge badge-danger"></span></h4>
                          
                          <img src="/website_tmdt/assets/uploads/sanpham/<?= $row['hinhsp'] ?>" alt="..." class="img-thumbnail">
                          <p class="text-2">
                            <span class="text-2"> <a class="text-2" href=""></a></span>
                          </p>
                        </div>
                        <!-- thông tin chi tiết  -->
                      </div>
